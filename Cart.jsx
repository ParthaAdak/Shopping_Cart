...
const Cart = () => {
  ...
  return (
    <div className="flex items-center justify-between max-w-6xl mx-auto p-8 mt-15">
  {
    cart.length > 0  ? 
    (<div className="flex flex-col lg:flex-row w-full">
      ...
      <div className="lg:ml-8 mt-8 lg:mt-0 p-6 flex flex-col justify-between h-[80vh] w-full lg:w-1/3 lg:sticky lg:top-20">
        ...
        <div className="text-lg text-gray-700 font-semibold">
          ...
          <button className="mt-4 bg-green-600 text-white py-2 px-4 w-full rounded hover:bg-green-700 transition-all duration-300">
            CheckOut Now
          </button>
        </div>
    ...
    (<div className="flex items-center justify-between h-screen">
     <div className="flex flex-col items-center ml-[480px]">
